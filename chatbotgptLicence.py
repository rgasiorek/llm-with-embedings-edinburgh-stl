...
def summrize(documnet):
    ...
    for chunk in chunks:
        ...
        if summary.startswith("GPT-3 error:"): return summary
        summaries.append(summary)
    return ''.join(summaries)

#read the pdf file
document = read_pdf("/Users/eyeyeye/Downloads/CEC_Short_Term_Let_Licensing_Policy___Updated_July_2023_Final.pdf")

# Call the summrize function with the document as input
print("result:"+summrize(document))